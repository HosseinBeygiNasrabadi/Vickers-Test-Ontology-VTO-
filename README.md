...
```
cd existing_repo
git remote add origin https://gitlab.com/kupferdigital/ontologies/vickers-hardness-test.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/kupferdigital/ontologies/vickers-hardness-test/-/settings/integrations)
